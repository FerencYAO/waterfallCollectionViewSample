 ...
 */
@protocol CHTCollectionViewDelegateWaterfallLayout <PSUICollectionViewDelegate>
@required
/**
 ...
 *    headerHeight
 */
- (CGFloat)collectionView:(PSUICollectionView *)collectionView layout:(PSUICollectionViewLayout *)collectionViewLayout heightForHeaderInSection:(NSInteger)section;
 ...
 *    footerHeight
 */
- (CGFloat)collectionView:(PSUICollectionView *)collectionView layout:(PSUICollectionViewLayout *)collectionViewLayout heightForFooterInSection:(NSInteger)section;
@end
 ...
 */
@interface CHTCollectionViewWaterfallLayout : PSUICollectionViewLayout
